	...
	<body class="cbp-spmenu-push">
		<div class="main-content">
			...
			<div id="page-wrapper">
				<div class="main-page">
					<div class="forms">
						<h3 class="title1">上传歌曲</h3>
						<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
							<div class="form-title">
								<h4>歌曲基本信息:</h4>
							</div>
							<div class="form-body">
								<form action="${pageContext.request.contextPath }/servlet/FileInputServlet?op=input"enctype="multipart/form-data" method="post">
									<div class="form-group">
										<label >歌曲名：</label> 
										<input name="title" class="form-control" placeholder="music" type="text" > 
										<p class="help-block">${msgError.title }</p> 
									</div> 
									<div class="form-group"> 
										<label>歌手：</label> 
										<input name="singer" class="form-control" placeholder="singer" type="text"> 
										<p class="help-block">${msgError.singer }</p> 
									</div> 
									<div class="form-group"> 
										<label>歌曲：</label> 
										<input name="song" type="file"> 
										<p class="help-block">${msgError.song }</p> 
									</div>
									<div class="form-group"> 
										<label>图片：</label> 
										<input name="picture" type="file"> 
											<p class="help-block">${msgError.picture }</p> 
									</div> 
									<div class="form-group"> 
										<label>歌词：</label> 
										<input name="lyrics" type="file"> 
											<p class="help-block">${msgError.lyrics }</p> 
									</div> 
									<div class="form-group"> 
